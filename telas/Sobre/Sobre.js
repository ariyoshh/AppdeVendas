...
const Sobre = () => {
  return (
    <View style={styles.container}>
          ...
          <Text style={styles.text}>Maria Luiza Machado Silva</Text>
          <Text style={styles.text}>081210041</Text>
          <Text style={styles.text}>Vinycius Ariyoshi Stevani</Text>
          <Text style={styles.text}>082190022</Text>
